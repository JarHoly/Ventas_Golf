...
const DICCIONARIO = {
  es: {
    ...
    "res.manana": "Mañana",
    "res.tarde": "Tarde",
    "res.proxima_libre": "Próxima libre",
    "res.libre": "Libre",
    "res.ocupada": "Ocupada",
    ...
    "pwa.paso_ios_3": "Confirmá y aparecerá un ícono de E Cuestas en tu pantalla de inicio.",
  ...
  en: {
    ...
    "res.manana": "Morning",
    "res.tarde": "Afternoon",
    "res.proxima_libre": "Next available",
    "res.libre": "Available",
    "res.ocupada": "Booked",
    ...
    "pwa.paso_ios_3": "Confirm, and an E Cuestas icon will appear on your home screen.",
